...
console.log(book); // 0 ... WHY? Because the ?? operator means : "If nurd.books === null or nurd.books === undefined, then book = 10". Note that - ONLY if the value is NULL or UNDEFINED... So what if the nerd.books = null or undefined? Then the result its gona be 10. In this case its = 0 which is not null or undefind
